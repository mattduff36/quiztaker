...
const KNOWLEDGE_DIR = process.env.SABA_KNOWLEDGE_DIR || path.join(ROOT, 'data', 'knowledge');
...
const QUIZ_TYPES_FILE = process.env.SABA_QUIZ_TYPES_FILE || path.join(ROOT, 'docs', 'QUIZ-TYPES.md');
